...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: 'Brand Design',
    categoryFr: 'Design de marque',
    cover: 'img/darling-brand-cover-v3.jpg',
    description:
    ...
    images: [
      { type: 'full', srcs: ['img/darling-brand-lineup-v3.jpg'], alts: ['Darling tea packaging — full range of box mockups across lemon, mojito, and strawberry flavors'] },
      {
        type: 'grid2',
